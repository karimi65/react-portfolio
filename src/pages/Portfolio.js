...
function Portfolio() {
    return (
        <div className="container">
            <h1>portfolio</h1>
            <div className="row">
                <Card image="/img/project1.JPG" alt="project1" name="work day" repo="https://github.com/karimi65/work-day-scheduler" web="https://karimi65.github.io/work-day-scheduler/" />
